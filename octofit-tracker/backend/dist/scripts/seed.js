...
async function seedDatabase() {
    try {
        ...
        await team_1.default.updateOne({ _id: teams[0]._id }, { $set: { members: [users[0]._id, users[1]._id] } });
        await team_1.default.updateOne({ _id: teams[1]._id }, { $set: { members: [users[2]._id, users[3]._id] } });
